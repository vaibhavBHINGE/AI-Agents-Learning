...
llm_obj=HuggingFaceEndpoint(
    repo_id="deepseek-ai/DeepSeek-V4-Pro",    # to extract the model from HuggingFace we need api token that is stored in .env file we importing that using load_dotenv() function
